"""Initial schema with Genre model

Revision ID: 54c182f35126
Revises: 
Create Date: 2026-07-19 19:17:04.102388
...
def upgrade():
    ...
    sa.Column('mood', sa.String(length=500), nullable=False),
    sa.Column('banner', sa.String(length=200), nullable=False),
